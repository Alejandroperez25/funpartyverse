...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { icon: <Instagram className="h-5 w-5" />, href: 'https://instagram.com/funneekiddee' },
    { icon: <Mail className="h-5 w-5" />, href: 'mailto:funneekiddee@gmail.com' },
    { icon: <Phone className="h-5 w-5" />, href: 'tel:+17279100076' }
  ];
