...
const Navbar: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'featured', label: t('nav.featured'), href: '#featured' },
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 font-bold text-2xl">
            <a href="/" className="flex items-center">
              <span className="text-funneepurple text-4xl font-toybox">Funnee</span>
              <span className="text-funneeorange text-4xl font-toybox">Kiddee</span>
            </a>
          </div>
