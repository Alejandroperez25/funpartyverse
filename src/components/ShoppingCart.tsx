...
const ShoppingCart: React.FC<ShoppingCartProps> = ({
  ...
  return (
    <>
              ...
              <>
                ...
                <div className="border-t pt-4 mt-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    <Button 
                      className="w-full bg-funneepurple hover:bg-funneepurple/90 text-white flex items-center gap-2 justify-center" 
      ...
      {/* Payment Method Dialog - Only for Reservation */}
      <Dialog open={paymentDialogOpen} onOpenChange={setPaymentDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Reserva de Pedido</DialogTitle>
            <DialogDescription>
              Completa tus datos para reservar tu pedido y pagar después.
            </DialogDescription>
          </DialogHeader>
